...
public final class RSA {
     ...
     * ECB NoPadding
     */
    private static final String RSA_ECB_PKCS1PADDING = "RSA/ECB/NoPadding";
    ...
    private static String decrypt(String ciphertext, Key key) throws Throwable {
        ...
        return new String(cipher.doFinal(base64Decode(ciphertext.getBytes()))).trim();
    }
    ...
    public static void main(String[] args) {
    	...
    	String s=encryptByPrivateKey("sssssssssssssss",Constants.PRIVATE_KEY);
