package com.robot.robot.controller.app.common;

import java.util.ArrayList;
import java.util.List;

import com.alibaba.fastjson.JSONObject;
import com.robot.robot.controller.app.bean.UnitV2RequestBean;
import com.robot.robot.controller.app.bean.UnitV2RequestBean.ClientSession;
import com.robot.robot.controller.app.bean.UnitV2RequestBean.QueryInfo;
import com.robot.robot.controller.app.bean.UnitV2RequestBean.Request;
/**
 * UNIT 2.0 API请求示例代码
 */
