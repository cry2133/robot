...
var prefix2 = "/robot/tKeywordReplace"
$(function() {
	loadReplace();
});
						...
						columns : [
								...
								},
								{
									...
									formatter : function(value, row, index) {
										var e = '<a class="btn btn-primary btn-sm '+s_edit_h+'" href="#" mce_href="#" title="编辑" onclick="editReplace(\''
												+ row.replaceId
												+ '\')"><i class="fa fa-edit"></i></a> ';
										var d = '<a class="btn btn-warning btn-sm '+s_remove_h+'" href="#" title="删除"  mce_href="#" onclick="removeReplace(\''
												+ row.replaceId
